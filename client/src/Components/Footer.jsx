...
<footer className="relative bg-blueGray-200 pb-6 mt-10">
      ...
      <div className="w-full lg:w-6/12 px-4">
        <div className="flex flex-wrap items-top mb-6">
          <div className="w-full lg:w-4/12 px-4 ml-auto">
            <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Info.</span>
            <ul className="list-unstyled">
              ...
              <li>
                <Link to="/Search-hotel" className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" >Search</Link>
              </li>
