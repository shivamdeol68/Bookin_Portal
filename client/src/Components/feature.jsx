...
const Service = () => {
  return (
    <section className="pt-4  pb-8 lg:pb-[70px]">
  <div >
    ...
    <div className=" flex flex-wrap items-center justify-center mx-4">
      <div className="w-full md:w-1/2 lg:w-1/4 px-4">
        <div className="bg-white mb-12 group wow fadeInUp " data-wow-delay=".1s">
         ...
         <div>
           <h4 className="font-bold text-xl text-dark mb-3 flex
            items-center
            justify-center">
            Fast Services
          </h4>
          <p className="text-body-color mb-8 lg:mb-11 flex
            items-center
            justify-center">
            Lorem Ipsum is simply dummy text of the printing and industry.
          </p>
          <Link to="/about" href="javascript:void(0)" className="font-medium text-base text-body-color hover:text-primary flex
            items-center
            justify-center">
            Learn More
          </Link>
