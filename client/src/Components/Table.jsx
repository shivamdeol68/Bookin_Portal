  ...
  <div>
    ...
    <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <li className='flex  mt-2 mb-5' >
        <Avatar showFallback isBordered color="primary" src='https://i.pinimg.com/736x/c0/27/be/c027bec07c2dc08b9df60921dfd539bd.jpg' />
        <h4 className='mx-6 pt-2'>Admin</h4>
        </li>
        <li>
          <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <Link to="/Admin"><span className="ms-3">Dashboard</span></Link>
          </a>
        </li>
        <li>
          <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <Link to="/Table"><span className="flex-1 ms-3 whitespace-nowrap">Table</span></Link>
        ...
        <table className="min-w-full bg-white">
          <thead className="bg-gray-800 text-white">
            <tr>
              ...
              <th className="text-left py-3 px-4 uppercase font-semibold text-sm">Email
              </th></tr>
          </thead>
