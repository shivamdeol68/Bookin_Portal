      ...
      <div className="w-full mx-4">
        <div className="wow fadeInUp" data-wow-delay=".2s">
          <div className="ud-title mb-8">
            ...
            ">
              Some Of Our Clients
              <span className="w-8 h-[1px] inline-block bg-[#afb2b5] ml-4">
              </span>
            </h6>
          </div>
          <div className="ud-brands-logo flex items-center flex-wrap">
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner">
                <img src="assets/images/brands/tailgrids.svg" alt="tailgrids" className="grayscale hover:filter-none duration-300" />
              </a>
            </div>
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              <a href="https://ayroui.com" target="_blank" rel="nofollow noopner">
                <img src="assets/images/brands/ayroui.svg" alt="ayroui" className="grayscale hover:filter-none duration-300" />
              </a>
            </div>
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              <a href="https://uideck.com" target="_blank" rel="nofollow noopner">
                <img src="assets/images/brands/uideck.svg" alt="uideck" className="grayscale hover:filter-none duration-300" />
              </a>
            </div>
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              <a href="https://graygrids.com" target="_blank" rel="nofollow noopner">
                <img src="assets/images/brands/graygrids.svg" alt="graygrids" className="grayscale hover:filter-none duration-300" />
              </a>
            </div>
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              <a href="https://lineicons.com" target="_blank" rel="nofollow noopner">
                <img src="assets/images/brands/lineicons.svg" alt="lineicons" className="grayscale hover:filter-none duration-300" />
              </a>
            </div>
          </div>
        </div>
