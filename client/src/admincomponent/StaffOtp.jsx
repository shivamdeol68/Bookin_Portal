...
import { verifyOtp_staff } from "../redux/action/staff";
...
export default function StaffOtp() {
    ...
    const sucess = useSelector((state) => state.Staffs.success);
    ...
    const handlesubmitotp = (e) => {
      e.preventDefault();
      dispatch(verifyOtp_staff(useotp, navigate));
    };
    return (
      <>
